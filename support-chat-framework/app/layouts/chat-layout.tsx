                        ...
                        <div className="space-y-1">
                            ...
                            <div className="space-y-1">
                                <NavLink
                                    ...
                                    aria-label="Chat with G5 Customer"
                                >
                                    <div className="h-6 w-6 rounded-full bg-blue-500/20 text-blue-600 dark:text-blue-400 flex-shrink-0 flex items-center justify-center font-semibold text-xs">
                                        G5
                                    </div>
                                    <span className="truncate">G5 Customer</span>
                                </NavLink>
                                <NavLink
                                    to="/chat/DEF"
                                    className={({ isActive }) =>
